...
app.config['MYSQL_USER'] = 'sql6436510'
app.config['MYSQL_PASSWORD'] = '4Vyk3q2g4i'
app.config['MYSQL_DB'] = 'sql6436510'
...
def pneumonia():
    ...
    s3.Bucket(bucket_name).upload_fileobj(x1,"file.jpg")
    response = requests.get("https://pneumonia-predictor.s3.ap-south-1.amazonaws.com/file.jpg")
    file = open("xray.jpg", "wb")
    file.write(response.content)
    file.close()
    img = load_img("xray.jpg", target_size=(180, 180))
    ...
    if(prediction[0] > 0.5):
        ...
        data = "You are Normal"
    return render_template('prediction.html', data=data, account = account)
